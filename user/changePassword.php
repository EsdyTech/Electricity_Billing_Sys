                 ...
                 <div class="row">
                    <div class="col-sm-3">
                      <div class="form-group">
                        ...
                        <input type="text" readonly name="firstName" value="<?php echo $retsss['accountNo'];?>" class="form-control" placeholder="Account No">
                      </div>
                    </div>
                    <div class="col-sm-3">
                      <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <div class="form-group">
                        ...
                        <input type="text" name="phoneNo" value="<?php echo $retsss['phoneNo'];?>" class="form-control" placeholder="Phone No">
                      </div>
                    </div>
                    <div class="col-sm-9">
                      <div class="form-group">
                        <label>Home Address</label>
                        <input type="text" required name="address" value="<?php echo $retsss['address'];?>" class="form-control" placeholder="Address">
                      </div>
                    </div>
                  </div>
                </div>
