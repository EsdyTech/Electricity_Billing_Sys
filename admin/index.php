        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
              <?php
              $customersQuery=mysqli_query($con,"SELECT * from users_tbl");                       
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
              <?php 
              $mailsQuery=mysqli_query($con,"SELECT * from complaint_tbl");                       
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
              <?php
              $couriersQuery=mysqli_query($con,"SELECT * from complainttype_tbl");                       
          ...
          <!-- ./col -->
            ...
            <div class="small-box bg-danger">
              ...
              <?php 
              $dateCr = date('Y-m');
              $packageCatQuery=mysqli_query($con,"SELECT * from bill_tbl");                       
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
              <?php 
              $packageWeightQuery=mysqli_query($con,"SELECT * from bill_tbl where status = 'Pending'");                       
          ...
          <div class="col-lg-3 col-6">
            <div class="small-box bg-info">
              <div class="inner">
              <?php 
            $stampQuery=mysqli_query($con,"SELECT * from bill_tbl where status = 'Paid'");                       
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
              <?php 
              $packageSizeQuery=mysqli_query($con,"SELECT * from transaction_tbl");                       
